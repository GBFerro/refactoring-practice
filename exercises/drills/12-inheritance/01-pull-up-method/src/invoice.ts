import type { GroupLesson } from "./group-lesson";
import type { PrivateLesson } from "./private-lesson";
...
export function totalBillingCents(lessons: readonly BillableLesson[]): number {
