...
export class Branch {
  ...
  isManagerCertifiedForRareBooks(): boolean {
    return this.#manager.isCertifiedForRareBooks();
  }

  managerYearsOfService(): number {
    return this.#manager.yearsOfService();
  }

  isManagerOnLeave(): boolean {
    return this.#manager.isOnLeave();
  }
}
